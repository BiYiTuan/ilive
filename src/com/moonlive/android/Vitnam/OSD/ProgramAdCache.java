...
static Logger logger = Logger.getInstance();
	...
	public static boolean isExist(String tvid){
		logger.i("Program cache file = " + Configs.CONTENT_CACHE_FILE+tvid);
		File file = new File(Configs.CONTENT_CACHE_FILE+tvid);
		return file.exists();
	}
	
	public static boolean isDirectory(String tvid){
		File file = new File(Configs.CONTENT_CACHE_FILE+tvid);
		return file.isDirectory();
	}
	
	public static boolean delFile(String tvid){
		File file = new File(Configs.CONTENT_CACHE_FILE+tvid);
		if(file.exists())
			return file.delete();
		return false;
	...
	public static void save(String saveGsonStr, String tvid){
		File file = new File(Configs.CONTENT_CACHE_FILE + tvid);
	...
	public static String getGsonString(String tvid){
		File file = new File(Configs.CONTENT_CACHE_FILE+tvid);
		if(file.isDirectory()) return "";
		BufferedReader br = null;
		try {
			br = new BufferedReader(new FileReader(Configs.CONTENT_CACHE_FILE+tvid));
			String resultStr = "";
	...
	public static boolean checkIsSame(String gsonStr,String tvid){
		File file = new File(Configs.CONTENT_CACHE_FILE+tvid);
