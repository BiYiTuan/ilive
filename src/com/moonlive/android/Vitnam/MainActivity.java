...
import com.moonlive.android.Vitnam.OSD.OSDAd;
import com.moonlive.android.Vitnam.OSD.OSDCache;
import com.moonlive.android.Vitnam.OSD.OSDListProgram;
import com.moonlive.android.Vitnam.OSD.OSDManager;
import com.moonlive.android.Vitnam.OSD.OSDNetworkPrompt;
import com.moonlive.android.Vitnam.OSD.OSDProgramNum;
import com.moonlive.android.Vitnam.OSD.OSDVolume;
import com.moonlive.android.Vitnam.OSD.ProgramAdCache;
import com.moonlive.android.Vitnam.OSD.ProgramCache;
import com.moonlive.android.Vitnam.model.Ad;
import com.moonlive.android.Vitnam.model.ForceLoadItem;
import com.moonlive.android.Vitnam.model.LiveData;
...
import com.moonlive.android.Vitnam.util.NetworkUtil;
import com.moonlive.android.Vitnam.util.RequestUtil;
import com.moonlive.android.Vitnam.util.ScreenUtils;
import com.moonlive.android.Vitnam.util.StringUtil;
import com.moonlive.android.Vitnam.util.VersionUtil;
import com.moonlive.android.Vitnam.view.CustomToast;
import com.moonlive.android.Vitnam.view.GGTextView;
import com.moonlive.android.Vitnam.view.MarqueeTextView;
import com.moonlive.android.Vitnam.view.VideoView;
import com.moonlive.android.Vitnam.white.ChianPull;
import com.moonlive.android.Vitnam.white.Pull;
...
//				changeChannelToPlay(position,inAllPos);
			...
			case Configs.NETWORK_CONNECT:
				...
				if(VodHistory.getAuthCacheStatus(MainActivity.this) && !StringUtil.isBlank(link) && !StringUtil.isBlank(key)){
					Configs.key = key;
					Configs.link = link;
				...
				new FinalRequestDAO().checkAuth(MainActivity.this,this);
				break;
			...
			case Configs.READ_CACHE:
				...
				if(ProgramCache.isExist() && !ProgramCache.isDirectory()){
					//�����б�
					log.i("��ȡ�����е��б�");
					String gsonCacheStr = ProgramCache.getGsonString();
					//��ȡ�����е��б?�����е��б�������?������ȥ�б?ȥ���б������
			...
			case Configs.AUTH_SUCCESS_CACHE:
				new UpgradeAndRequest(MainActivity.this).sendRequest();
		...
		private void startPlay() {
			...
			int screenSize[] = ScreenUtils.getScreenSize2(MainActivity.this);
	...
	private BroadcastReceiver mMsgReceiver = new BroadcastReceiver(){
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(Configs.BroadCast.UPDATE_MSG.equals(intent.getAction())){
				...
				new FinalRequestDAO().initPopWindow(appUrl, updata,MainActivity.this,mHandler);
			} 
		}
	};
...
//			file.delete();
	...
	private void prarseAdAndShow(int position) {
		...
		boolean isAdExist = ProgramAdCache.isExist(tvid);
		int sec = 0;
		...
		if(isAdExist){
			log.i("ad exist");
			String content = ProgramAdCache.getGsonString(tvid);
			try{
...
//		msg.setData(bundle);
		...
		if(!liveData.isHasGetAd())
			new FinalRequestDAO().getProgramAd(liveData,0);
	}
		...
		public void onSuccess(JSONObject response) {
			...
			try {
				...
				if (0 == error_code) {
					...
					WhiteListControl.setHeartBeat(MainActivity.this, MACUtils.getMac(),
							serverAddress, serverPort);
					AlarmUtil.addAlarm(MainActivity.this);
				} else {
					log.e(message);
				}
