...
public class Configs {
	...
	public static final String APPID = "860001";
	public static final String PKG_NAME = "com.moonlive.android.iptv";
    ...
    public static String getHttpServer01(){
    	return "http://alive.videocn.video:9007";
    }
    public static String getHttpServer02(){
    	return "http://alive.hujck.rocks:9007";
    }
    public static String getHttpServer03(){
    	return "http://alive.klecb.link:9007";
    }
